...
const checks = [
  ...
  "Failure handling around model calls",
  "Documentation of assumptions and owner review"
];
      ...
      <section className="border-b border-ink/10 bg-white">
        <div className="mx-auto max-w-6xl px-5 py-14">
          ...
          <h1 className="mt-3 max-w-3xl text-4xl font-semibold leading-tight text-ink">
            AI workflow reliability checks
          </h1>
          <p className="mt-5 max-w-3xl text-lg leading-8 text-ink/72">
            AI workflow steps are fragile when unstructured model output flows directly into downstream systems without validation or fallback behavior.
          </p>
