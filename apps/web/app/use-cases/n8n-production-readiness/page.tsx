...
const checks = [
  "Error handling and failure branches",
  "Retry, timeout, and fallback behavior",
  "Logging and owner notification signals",
      ...
      <section className="border-b border-ink/10 bg-white">
        <div className="mx-auto max-w-6xl px-5 py-14">
          ...
          <h1 className="mt-3 max-w-3xl text-4xl font-semibold leading-tight text-ink">
            n8n production readiness checks
          </h1>
          <p className="mt-5 max-w-3xl text-lg leading-8 text-ink/72">
            n8n workflows often move from prototype to business-critical automation before error handling, ownership notes, and release checks are in place.
          </p>
